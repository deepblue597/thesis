...
def train_and_predict(X):
    ...
    model.learn_one(X, None)

    y_predicted = model.score_one(X, None)

    print(y_predicted)

    with open('GaussianScorer.pkl', 'wb') as model_file:
...
with open('../../GaussianScorer.pkl', 'rb') as model_file:
