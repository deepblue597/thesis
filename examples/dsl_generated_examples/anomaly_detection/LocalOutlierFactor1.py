...
app = Application(
    ...
    consumer_group="LocalOutlierFactor1",
)

# Define the Kafka topics
input_topic = app.topic("anomaly-pred", value_deserializer="json")

output_topic = app.topic("LocalOutlierFactor-anomaly",
...
def train_and_predict(X):
    ...
    with open('LocalOutlierFactor1.pkl', 'wb') as model_file:
...
with open('../../LocalOutlierFactor1.pkl', 'rb') as model_file:
